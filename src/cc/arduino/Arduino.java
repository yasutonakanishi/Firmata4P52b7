...
public class Arduino {
  ...
  public class SerialProxy extends PApplet {
	//RegisteredMethods disposeMethods;  
    public SerialProxy() {
      ...
      /* in Processing2.0, this field is commented out. */    
      //disposeMethods = new RegisteredMethods(); 
      this.registerMethod("dispose", this); //revised for Processing2.0
    }
  ...
  public Arduino(PApplet parent, String iname, int irate) {
    ...
    parent.registerMethod("dispose", this); //revised for Processing2.0
  }
